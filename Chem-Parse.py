...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def initGUI(self, fileName=None):
        ...
        self.logoDock.setFeatures(QtWidgets.QDockWidget.NoDockWidgetFeatures)
        self.logoDock.setTitleBarWidget(QtWidgets.QWidget())  # Hide the title bar
        self.logoDock.setFixedWidth(800)  # Adjust width as needed
...
""")
    ...
    QComboBox QAbstractItemView {
        ...
        self.dockWidget.setFixedWidth(100) # Only allow left docking
        ...
        self.dockWidget_2.setFixedHeight(80)
        ...
        self.pushButton_8.setIconSize(QtCore.QSize(35, 65))
