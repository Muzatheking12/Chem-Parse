...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, fileName=None, loglevel="Info"):
...
""")
    ...
    QComboBox QAbstractItemView {
        ...
        def get_png():
            file, _ = QFileDialog.getOpenFileName(self, "Open PNG File", "", "PNG Files (*.png);; JPG (*.jpg);; JPEG (*.jpeg) ;; All Files (*)")
            if file:
                ...
                if smiles:
                        ...
                        if mol:
                            ...
                            self.editor.logger.warning(f"Failed Convert to  PNG: {repr(smiles)}")
        ...
        self.pushButton_6.clicked.connect(get_png)
    ...
    def retranslateUi(self):
        ...
        self.pushButton_6.setStatusTip(_translate("MainWindow", "Convert Image to SMILES"))
        self.pushButton_6.setWhatsThis(_translate("MainWindow", "Convert Image to SMILES"))
