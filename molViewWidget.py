...
class QtErrorDialogHandler(logging.Handler, QtCore.QObject):
...
class MolWidget(QtSvgWidgets.QSvgWidget):
    def __init__(self, mol=None, parent=None, moldrawoptions: rdMolDraw2D.MolDrawOptions = None):
        ...
        error_handler = QtErrorDialogHandler(self)
    ...
    def sanitizeDrawMol(self, kekulize=False, drawkekulize=False):
        ...
        try:
            ...
            self.logger.warning("The added atom/bond/ring is of incorrect valency or is otherwise not sanitizable")
