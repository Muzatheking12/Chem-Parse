...
class TemplateHandler:
    ...
    templates = {
        ...
        "furan": {
            "canvas": "C1=COC=C1",
            "atom": "[998*:1]>>[beginisotope*:1]1=COC=C1",
            "sp3": "[998*:1]-[999*:2]>>[beginisotope*:1]1-[endisotope*:2]=C-O-C=1",
            "sp2": "[998*:1]~[999*:2]>>[beginisotope*:1]1~[endisotope*:2]-O-C=C-1",
            "aromatic": "[998*:1]~[999*:2]>>[beginisotope*:1]1:[beginisotope*:2]:o:c:c:1",
        },
        "pyrrole": {
            "canvas": "C1=CC=NC1",
            "atom": "[998*:1]>>[beginisotope*:1]1=CC=NC1",
            "sp3": "[998*:1]-[999*:2]>>[beginisotope*:1]1-[endisotope*:2]=C-N-C=1",
            "sp2": "[998*:1]~[999*:2]>>[beginisotope*:1]1~[endisotope*:2]-N-C=C-1",
            "aromatic": "[998*:1]~[999*:2]>>[beginisotope*:1]1:[beginisotope*:2]:n:c:c:1",
        },
        "thiophene": {
            "canvas": "C1=CC=CS1",
            "atom": "[998*:1]>>[beginisotope*:1]1=CC=CS1",
            "sp3": "[998*:1]-[999*:2]>>[beginisotope*:1]1-[endisotope*:2]=C-C-S=1",
            "sp2": "[998*:1]~[999*:2]>>[beginisotope*:1]1~[endisotope*:2]-C-S=C-1",
            "aromatic": "[998*:1]~[999*:2]>>[beginisotope*:1]1:[beginisotope*:2]:s:c:c:1",
        }
